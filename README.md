...
[![My Skills](https://skillicons.dev/icons?i=html,css,react,nodejs,js,vite,tailwind,ts,express,mongodb,postgres,prisma,remix,redis,nextjs,linux,graphql,docker,neovim,lua,aws,arch,bash,git,github)
